...
Webflow.define('ix', function ($, _) {
  ...
  function build(i, el) {
    ...
    // Set initial styles, unless we detect a touch device + any non-touch triggers
    var setStyles = !(touch && _.any(triggers, nonTouch));
    ...
    _.each(triggers, function (trigger) {
      ...
      if (type == 'load') {
        setTimeout(function () { run(trigger, el); }, 1);
      }
  ...
  function run(trigger, el, opts) {
    ...
    // var _old = _tram;
    // _tram = {
    //   add: function (transition, arg) {
    //     console.log('tram::add', transition, arg, el);
    //     _old.add.call(_old, transition, arg);
    //   },
    //   set: function (arg) {
    //     console.log('tram::set', arg, el);
    //     _old.set.call(_old, arg);
    //   },
    //   then: function (arg) {
    //     console.log('tram::then', arg, el);
    //     _old.then.call(_old, arg);
    //   },
    //   wait: function (arg) {
    //     console.log('tram::wait', arg, el);
    //     _old.wait.call(_old, arg);
    //   },
    //   redraw: function () {
    //     console.log('tram::redraw', el);
    //     _old.redraw.call(_old);
    //   },
    //   start: function (arg) {
    //     console.log('tram::start', arg, el);
    //     _old.start.call(_old, arg);
    //   }
    // };
    // -----------------------------------
    ...
    // Add final step for callback
    if (done && meta.start) {
      _tram.then(function () { done(); });
    } else if (done) {
      done();
    }
  }
